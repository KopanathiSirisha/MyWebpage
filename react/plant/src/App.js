...
const App = () => {
  ...
  const [plants, setPlants] = useState([
    ...
    { id: 3, name: "Fiddle Leaf Fig", price: 100, image: "🪴", description: "Popular indoor tree with large violin-shaped leaves", inStock: false },
    { id: 4, name: "Peace Lily", price: 150, image: "🌸", description: "Elegant flowering plant that thrives in shade", inStock: true },
    { id: 5, name: "Aloe Vera", price: 90, image: "🌵", description: "Healing succulent that's easy to care for", inStock: true },
    { id: 6, name: "Pothos", price: 180, image: "🍃", description: "Trailing vine plant perfect for hanging baskets", inStock: true }
  ]);
              ...
              {plants.map(plant => (
                <div key={plant.id} className="product-card">
                  ...
                  <div className="product-footer">
                    ...
                    <button className="add-to-cart-btn" onClick={() => addToCart(plant)} disabled={!plant.inStock}>
          ...
          <div className="payment-content">
            ...
            <form className="payment-form">
              ...
              <div className="payment-buttons">
                ...
                <button type="button" onClick={handlePayment}>Pay ₹{getTotal()}</button>
              </div>
            </form>
          </div>
        </div>
